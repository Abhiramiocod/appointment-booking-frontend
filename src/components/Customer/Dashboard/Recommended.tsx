      ...
      <div className="grid grid-cols-1 gap-4">
        {recommended.map((item) => (
          ...
          >
            ...
            <button
              onClick={() => navigate("/customer/book", { state: { preselectedService: item.rawService } })}
              className="mt-6 w-full py-2.5 rounded-xl border border-indigo-200 text-indigo-600 font-bold text-sm hover:bg-indigo-600 hover:text-white transition-colors"
            >
              Book Now
            </button>
          </div>
