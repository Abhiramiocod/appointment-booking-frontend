          ...
          >
            <div className="px-3 py-2 border-b border-gray-100 bg-slate-50/50">
              <p className="text-sm font-semibold text-slate-800 truncate flex items-center gap-1.5">
                <span>👤</span> {user?.name || "Abhiram Santhosh"}
              </p>
            </div>
            ...
            <div className="p-1 border-b border-gray-100">
              <MenuItem>
                <button
                  ...
                  className="group flex w-full items-center gap-2 rounded-lg py-2 px-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer text-left font-medium"
                >
                  My Profile
                </button>
              </MenuItem>
